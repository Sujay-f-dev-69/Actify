        ...
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center space-x-2">
            <div className="relative w-8 h-8">
              <Image src="https://th.bing.com/th/id/OIP.gPQnpUwG_GfeMC-76ExdQgHaFN?w=250&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" alt="ActiSathi Logo" fill className="rounded-md" />
            </div>
                  ...
                  {user && (
                    <div className="flex items-center gap-3 p-4 mb-6 rounded-lg bg-gray-50 dark:bg-gray-800">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-indigo-600 dark:text-indigo-400">{user.karma} Karma</div>
                      </div>
                    </div>
                  )}
